# PracticeProjects
A folder of projects undertaken to improve programming skills and start small projects adapted from [150 Java Programming ideas](http://celestialcoding.com/java/150-java-program-ideas/ "150 Java Program Ideas").

The projects are compiled using the [cbt](https://github.com/cvogt/cbt "CBT") build tool. 
Add `cbt` to your path then in a project folder compile with `cbt compile` and run with `cbt direct run` (necessary for projects using ScalaFX)
